      ...
      (value) {
        context.read<PurchasesAndSalesBloc>().add(
              GetDailyPruchasAndSale(
                ...
                agentGuid: context.read<FiltesBloc>().state.selectedagent.guid,
                documentGuid:
                ...
                secondStoreGuid:
                    context.read<FiltesBloc>().state.secondSelectedStores.guid,
                          ...
                          context.read<PurchasesAndSalesBloc>().add(
                                GetDailyPruchasAndSale(
                                  ...
                                  transportCompaniesGuid: context
                                      ...
                                      .guid,
                                  dueDated:
                                      context.read<FiltesBloc>().state.dueDate,
                                  secondStoreGuid: context
                                      ...
                                      .guid,
                                  dateFrom:
                                      context.read<FiltesBloc>().state.fromDate,
                                  dateTo:
                                      context.read<FiltesBloc>().state.toDate,
                                ),
                              );
                        },
                        style: ElevatedButton.styleFrom(
