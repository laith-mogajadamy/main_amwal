    ...
    List griddata = [
      [
        ...
        () {
          ...
          context.read<EnterBloc>().add(PageChanged(page: 'customers'));
          context.read<CustomersBloc>().add(
                GetCustomers(
                  currency: context.read<EnterBloc>().state.selectedcurrency,
                  company: context.read<EnterBloc>().state.selectedcompany,
                  accountType:
                      context.read<EnterBloc>().state.selectedaccounttype,
                ),
              );
      ...
      [
        ...
        () {
          context.read<EnterBloc>().add(ClearFilters());
          context.read<EnterBloc>().add(PageChanged(page: 'suppliers'));
          context.read<CustomersBloc>().add(
                GetSuppliers(
                  currency: context.read<EnterBloc>().state.selectedcurrency,
                  company: context.read<EnterBloc>().state.selectedcompany,
